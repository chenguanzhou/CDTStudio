...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fontFamily" value="SimSun"/>
  ...
  <displayfield>GridCode</displayfield>
  <label>0</label>
  <labelattributes>
    <label fieldname="" text="标签"/>
    <family fieldname="" name="SimSun"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="GridCode"/>
  </edittypes>
  <editform></editform>
