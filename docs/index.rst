...
**CDTStudio** is an open-source and cross-platform desktop software in objact-based image analysis (OBIA or GeoOBIA). The first version of it is written by Chen Guanzhou (`English <https://github.com/chenguanzhou>`_, `中文 <http://www.chenguanzhou.com/about>`_).
