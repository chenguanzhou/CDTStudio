...
class MSTMethodInterface:public CDTSegmentationInterface
{
    ...
    Q_PROPERTY(double Threshold READ threshold DESIGNABLE true USER true)
    Q_PROPERTY(int Minimal_Object_Count READ minObjectCount DESIGNABLE true USER true)
    Q_PROPERTY(bool Shield_Null_Value READ shieldNulValue DESIGNABLE true USER true)
